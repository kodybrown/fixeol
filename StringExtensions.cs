...
//    while (index != -1) {
//      sb.Append(me[previousIndex..index]);
//      sb.Append(newValue);
...
//      foreach (var st in trimStrings) {
//        if (tempValue.StartsWith(st, comparison)) {
//          tempValue = tempValue[st.Length..];
//          foundOne = true;
//          foundCount++;
//        }
//      }
...
//    var tempValue = Value.TrimStart(comparison, trimStrings)
//                         .TrimEnd(comparison, trimStrings);
...
//  /// <returns></returns>
//  public static string TrimStartAndEnd( this string Value, string trimStart, string trimEnd )
//  {
//    return Value.TrimStartAndEnd(StringComparison.InvariantCulture, trimStart, trimEnd);
//  }
...
//    }
//    return me[0].ToUpper(culture) + me[1..].ToLower(culture);
//  }
...
//    for (var i = 0; i < me.Count; i++) {
//      for (var j = me.Count - 1; j >= i; j--) { // TODO j >= i or 0 ?
//        if (i != j && me[i] == me[j]) {
//          me.RemoveAt(j);
//          removedCount++;
//          break;
